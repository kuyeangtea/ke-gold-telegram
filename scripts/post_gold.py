...
Runs on GitHub Actions (no Mac required). It:
  ...
  2. Computes the price per chi  = spot / 31.1035 * 3.75  (rounded to whole number).
  3. Computes the 18K price per chi = gold price per chi * 0.75  (2 decimals).
...
def main():
    ...
    gold_per_chi = round(spot / GRAMS_PER_OZ * GRAMS_PER_CHI)
